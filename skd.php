...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/skdstyle.css">
...
<body>
    ...
    <div class="subnav-bar">
        <ul>
            ...
            <li><a href="skd.php" class="aktif">SURAT KETERANGAN USAHA</a>
    ...
    <h1>SURAT KETERANGAN USAHA</h1>
        <div class="row">
            <div class="skd">
                <h3>PERSYARATAN UNTUK SURAT KETERANGAN USAHA</h3>
                <ul>
                    <li>Surat Pengantar dari RT/RW</li>
                    <li>Foto Copy KTP/KK</li>
                    <li>Foto Copy Pasport WNA</li>
                    <li>(Proses 14 Hari Kerja)</li>
                </ul>
            </div>
        </div>
    </section>
