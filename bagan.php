        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Form Struktur Bagan</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="#" class="d-block">FORM Struktur Bagan</a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-responsive">
                                ...
                                <?php foreach ($bagan as $row) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="img/<?= $row["gambar"]; ?>" width="800"> </td>


                                        <td>
                                            <a href="ubahbagan.php?id=<?= $row["id"]; ?>"><span class="badge badge-warning"><i class="fas fa fa-edit"></i></span></a>
                                        </td>
