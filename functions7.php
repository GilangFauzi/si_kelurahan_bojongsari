...
function tambah($data)
{
    ...
    $tanggal = date("Y-m-d");
    // query insert data
    $query = "INSERT INTO matapencaharian
    VALUES
...
{
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM matapencaharian WHERE nomer = $nomer");
    return mysqli_affected_rows($koneksi);
}
...
function ubah($data)
{
    ...
    // query update data
    $query = "UPDATE matapencaharian SET
    nomer = '$nomer',
    uraian = '$uraian',
    jumlah = '$jumlah',
    tanggal = '$tanggal'
...
{
    $query = "SELECT * FROM matapencaharian WHERE 
