...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/spawtstyle.css">
...
<body>
    ...
    <div class="subnav-bar">
        <ul>
            ...
            <li><a href="spawt.php" class="aktif">SURAT PENYATAAN AHLI WARIS</a>
    ...
    <hr>
    <h1>SURAT PENYATAAN AHLI WARIS</h1>
        <div class="row">
            <div class="spawt">
                <h3>PERSYARATAN YANG DIBUTUHKAN UNTUK PEMBUATAN SURAT PENYATAAN AHLI WARIS</h3>
                <ul>
                    <li>Foto Copy Surat Keterangan Kematian (Lewat 5 Hari Kerja Harus dibuat Akte</li>
                    <li>Foto Copy KK/KTP Pewaris Ahli Waris</li>
                    <li>Surat Kuasa Pengurusan Waris</li>
                    <li>Foto Copy Akta Kelahiran (Keterangan Lahir Ahli Waris)</li>
                    <li>Surat Pernyataan Waris (disaksikan oleh RT/RW registrasi di kelurahan</li>
                    <li>Daftar Hadir Ahli Waris dari Kelurahan</li>
                </ul>
            </div>
        </div>
    </section>
