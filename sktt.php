...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/skttstyle.css">
...
<body>
    ...
    <div class="subnav-bar">
        <ul>
            ...
            <li><a href="sktt.php" class="aktif">SURAT KETERANGAN TEMPAT TINGGAL</a>
    ...
    <hr>
    <h1>SURAT KETERANGAN TEMPAT TINGGAL</h1>
        <div class="row">
            <div class="sktt">
                <h3>PERSYARATAN YANG DIBUTUHKAN UNTUK PEMBUATAN SURAT KETERANGAN TEMPAT TINGGAL (Pendatang dari Luar Daerah)</h3>
                <ul>
                    <li>Surat Pengantar dari RT/RW</li>
                    <li>Foto Copy KTP/KK</li>
                    <li>Surat Keterangan Pindah dari Daerah Asal (Koordinasi DISDUKCAPIL)</li>
                    <li>(Proses 2 Hari Kerja)</li>
                </ul>
            </div>
        </div>
    </section>
