        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Form Informasi</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="#" class="d-block">FORM Infromasi</a>
                    </div>
                </div>
                ...
                <div class="col-sm-10">
                    <div class="content">
                        <div class="container-fluid">
                            ...
                            <div class="col-md-2">
                                <div class="row mb-3"><a href="tambahinfo.php" class="btn btn-block btn-primary btn-sm">Tambah</a></div>
                            </div>
                            <table class="table table-striped table-responsive">
                                ...
                                <?php foreach ($informasi as $row) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row["info"]; ?></td>
                                        <td>
                                            <a href="ubahinformasi.php?id=<?= $row["id"]; ?>"><span class="badge badge-warning"><i class="fas fa fa-edit"></i></span></a> |
                                            <a href="hapusinformasi.php?id=<?= $row["id"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');"><span class="badge badge-danger"><i class="fas fa fa-trash"></i></span></a>
                                        </td>
