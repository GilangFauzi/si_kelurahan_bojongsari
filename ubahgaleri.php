                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="id" id="id" required value="<?= $galeri["id"]; ?>">
                                </div>
                                <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <a href="#" data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                                                        <img src="img/<?= $galeri['gambar']; ?>" class="img-fluid mb-2" alt="white sample" />
                                                    </a>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" name="keterangan" id="keterangan" required value="<?= $galeri["keterangan"]; ?>"></textarea>
                                </div>
                                <div class="card-body">
                                    <a href="galeri.php" class="btn btn-primary">Kembali</a>
