...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/skckstyle.css">
...
<body>
    ...
    <div class="subnav-bar">
        <ul>
            ...
            <li><a href="skck.php" class="aktif">PENGANTAR SKCK</a>
            
        </ul>
    </div>
    <hr>
    <h1>SURAT KETERANGAN CATATAN KEPOLISIAN</h1>
        <div class="row">
            <div class="skck">
                <h3>PERSYARATAN PENGANTAR SURAT KETERANGAN CATATAN KEPOLISIAN</h3>
                <ul>
                    <li>Surat pengantar dari Rukun Tetangga (RT) dan Rukun Warga (RW)</li>
                    <li>Foto copy KK (Kartu Keluarga) jika sudah berkeluarga</li>
                    <li>Foto copy Kartu Tanda Penduduk (KTP) </li>
                    <li>Pas Foto Berwarna 4x6 sebanyak 3 lembar</li>
